...
public class FragmentMoreBindingImpl extends FragmentMoreBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.timetableITV, 1);
        sViewsWithIds.put(R.id.changesITV, 2);
        sViewsWithIds.put(R.id.zvonkiITV, 3);
        sViewsWithIds.put(R.id.weatherITV, 4);
        sViewsWithIds.put(R.id.newsITV, 5);
        sViewsWithIds.put(R.id.developersITV, 6);
        sViewsWithIds.put(R.id.feedbackITV, 7);
    }
    // views
    @NonNull
